...
export const playListData: Track[] = [
  {
    ...
    url: require('./assets/media/one.mp3'),
  },
  {
    id: 2,
    ...
    url: require('./assets/media/two.mp3'),
  },
  {
    id: 3,
    title: 'Kesariya',
    ...
    url: require('./assets/media/three.mp3'),
  },
  {
    id: 4,
    title: 'Title Track',
    ...
    url: require('./assets/media/four.mp3'),
  },
  {
    id: 5,
    title: 'Besharam Rang',
    ...
    url: require('./assets/media/five.mp3'),
  },
];
